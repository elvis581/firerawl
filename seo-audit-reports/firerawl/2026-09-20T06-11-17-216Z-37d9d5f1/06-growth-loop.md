...
- **open-graph-incomplete** (P3): Add accurate Open Graph title, description, URL, and representative image. Verification: Required Open Graph fields resolve and match visible page content.
