...
- Audit run: 2026-09-20T05:15:57.357Z-6e0d0957
- Site score: **24/100**
- AI Citation score: **42/100**
- Crawled pages: **22**
- P0 / P1 / P2 / P3: **11 / 71 / 53 / 0**
- Release decision: **BLOCKED**
- Audit mode: **audit_only**; execution capability: **report_only**
- Coverage: **full-discovered-scope** (22 page(s), general, tool, pricing, comparison)
...
- Site score 24 is below 85.
- 22 page(s) score below article threshold 85.
- AI Citation score 42 is below 75.
- 11 P0 issue(s) block publication.

## Five most serious issues

1. **P0 Title promise is not answered by the body** — http://localhost:3001/ (Inferred)
2. **P0 Title promise is not answered by the body** — http://localhost:3001/tools (Inferred)
3. **P0 Title promise is not answered by the body** — http://localhost:3001/tools/url-to-markdown (Inferred)
4. **P0 Title promise is not answered by the body** — http://localhost:3001/tools/webpage-to-markdown (Inferred)
5. **P0 Title promise is not answered by the body** — http://localhost:3001/tools/website-to-markdown (Inferred)
